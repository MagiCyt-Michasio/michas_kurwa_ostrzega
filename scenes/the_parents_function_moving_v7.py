...
class TheParentsFunctionMovingV7(MovingCameraScene):
    def construct(self):
        child_color = "#D946EF"
        parent_color = "#22D3EE"
        grid_color = "#111111"
        ...
        def update_camera(mob):
            ...
            py = parent_y(ct)
            y_center = (cy + py) / 2
            # Kamera sztywno przyklejona do Child dot: kropka ma być 2.5 jednostki na prawo od środka
            mob.move_to([ct - 2.5, y_center, 0])
